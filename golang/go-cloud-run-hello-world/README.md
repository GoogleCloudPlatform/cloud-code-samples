...
"Hello World" is a [Cloud Run](https://cloud.google.com/run/docs?utm_source=ext&utm_medium=partner&utm_campaign=CDR_kri_gcp_cloudcodereadmes_012521&utm_content=-) application that renders a simple webpage.
