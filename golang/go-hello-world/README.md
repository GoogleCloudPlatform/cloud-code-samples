...
1. To run your application, click the Cloud Code status bar and select **Run on Kubernetes**.  
...
3. View the build progress in the OUTPUT window. After the build has finished, click the URL in the OUTPUT window to view your live application.  
...
1. Click the Run/Debug Configurations dropdown on the top taskbar and then select **Edit Configurations**.    
...
1. Select **Develop on Kubernetes** from the configuration drop down and click the run icon. Cloud Code runs your app in a local [minikube](https://minikube.sigs.k8s.io/docs/start/) cluster.  
