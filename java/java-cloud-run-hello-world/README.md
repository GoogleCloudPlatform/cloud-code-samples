...
1. Click the Cloud Code status bar and select **Run on Cloud Run Emulator**.  
...
4. View the build progress in the OUTPUT window. After the build has finished, click the URL in the OUTPUT window to view your live application.  
